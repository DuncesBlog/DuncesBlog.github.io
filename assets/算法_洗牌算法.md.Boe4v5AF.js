import{_ as s,c as i,o as a,a4 as n}from"./chunks/framework.iMXuyU9c.js";const g=JSON.parse('{"title":"洗牌算法(Knuth_Durstenfeld算法) shuffle","description":"","frontmatter":{},"headers":[],"relativePath":"算法/洗牌算法.md","filePath":"算法/洗牌算法.md"}'),t={name:"算法/洗牌算法.md"},h=n(`<h1 id="洗牌算法-knuth-durstenfeld算法-shuffle" tabindex="-1">洗牌算法(Knuth_Durstenfeld算法) shuffle <a class="header-anchor" href="#洗牌算法-knuth-durstenfeld算法-shuffle" aria-label="Permalink to &quot;洗牌算法(Knuth_Durstenfeld算法) shuffle&quot;">​</a></h1><pre><code>洗牌算法是一种将数组内所有元素均匀的打乱的一种算法
文章参考
